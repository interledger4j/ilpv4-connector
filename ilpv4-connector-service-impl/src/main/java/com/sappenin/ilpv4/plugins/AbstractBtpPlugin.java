...
public abstract class AbstractBtpPlugin implements Plugin {
   ...
   * @param accountAddress    The Interledger Address for this plugin.
   */
  ...
  public void doConnect() {
    ...
    logger.info("[{}] {} connecting to {}...", this.getPluginType().getPluginDescription(),
      this.getAccountAddress(), connectorSettings.getIlpAddress());
    this.connected.compareAndSet(false, true);
    logger
      .info("[{}] {} connected to {}!", this.getPluginType().getPluginDescription(), this.getAccountAddress(),
