...
/**
 * <p>A {@link Link} that implements the <tt>echo</tt> ILP Sub-protocol, which merely echoes back a
 * fulfillment to the caller in order to simulate something like <tt>ping</tt>.</p>
 *
 ...
 */
@Deprecated
public class EchoProtocolLink { //extends AbstractPlugin<PluginSettings> implements Plugin<PluginSettings> {
  ...
  //
  //    this.registerDataHandler((sourceAddress, incomingPacket) -> this.handleIncomingPacket(sourceAddress, incomingPacket));
  //  }
  //
  //  @Override
