...
import com.sappenin.interledger.ilpv4.connector.model.settings.AccountBalanceSettings;
...
import com.sappenin.interledger.ilpv4.connector.model.settings.DefaultRouteSettings;
import com.sappenin.interledger.ilpv4.connector.model.settings.ModifiableRouteBroadcastSettings;
import com.sappenin.interledger.ilpv4.connector.model.settings.RouteBroadcastSettings;
...
public class ConnectorSettingsFromPropertyFile implements ConnectorSettings {
  ...
  private DefaultRouteSettings defaultRouteSettings = new DefaultRouteSettingsFromPropertyFile();
  ...
  @Override
  public DefaultRouteSettings getDefaultRouteSettings() {
    return defaultRouteSettings;
  }

  public void setDefaultRouteSettings(DefaultRouteSettings defaultRouteSettings) {
   ...
   * Models the YAML format for spring-boot automatic configuration property loading.
   */
  public static class DefaultRouteSettingsFromPropertyFile implements DefaultRouteSettings {
