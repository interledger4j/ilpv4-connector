...
@ContextConfiguration(classes = {RedisBalanceTrackerConfig.class, RedisBalanceTrackerFulfillPacketTest.Config.class})
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
public class RedisBalanceTrackerFulfillPacketTest {

  @ClassRule
  public static final SpringClassRule SPRING_CLASS_RULE = new SpringClassRule();

  private static final int REDIS_PORT = 6379;
  private static final AccountId DESTINATION_ACCOUNT_ID = AccountId.of("1");
  ...
  @Test(expected = NullPointerException.class)
  public void updateBalanceForFulfillWithNullFromAmount() {
    try {
      balanceTracker.updateBalanceForFulfill(DESTINATION_ACCOUNT_ID, null);
    } catch (NullPointerException e) {
  ...
  public void updateBalanceForFulfillWhenNoAccountInRedis() {
    ...
    final BigInteger balance = balanceTracker.updateBalanceForFulfill(accountId, ONE);
  ...
  public void updateBalanceForFulfillWithParamterizedValues() {
    ...
    final BigInteger net_balance = balanceTracker.updateBalanceForFulfill(
      DESTINATION_ACCOUNT_ID, this.prepareAmount
    );
