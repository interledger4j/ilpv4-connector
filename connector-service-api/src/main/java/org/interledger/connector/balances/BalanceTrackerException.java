...
public class BalanceTrackerException extends RuntimeException {
   ...
   * @since 1.4
   */
  public BalanceTrackerException(Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.7
   */
  protected BalanceTrackerException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
