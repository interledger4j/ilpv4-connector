...
public interface ConfigConstants {
  ...
  String INTERLEDGER__CONNECTOR__KEYSTORE__JKS__SECRET0_PASSWORD =
      INTERLEDGER__CONNECTOR__KEYSTORE__JKS + DOT + "secret0_password";
  String INTERLEDGER__CONNECTOR__KEYSTORE__JKS__SECRET0_ALIAS =
      INTERLEDGER__CONNECTOR__KEYSTORE__JKS + DOT + "secret0_alias";
