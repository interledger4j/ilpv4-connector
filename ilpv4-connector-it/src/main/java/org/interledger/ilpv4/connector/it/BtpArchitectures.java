...
public class BtpArchitectures {
  ...
  static Graph oneConnectorGraph() {
    ...
    // Configure Connie
    ///////////////////
    graph.addNode(ALICE.getValue(), new ConnectorNode(new ConnectorServer(defaultConnectorSettings(ALICE))));
  ...
  static Graph twoPeerGraph() {
    ...
    ///////////////////
    // Configure Bob
    graph.addNode(BOB.getValue(), new ConnectorNode(new ConnectorServer(defaultConnectorSettings(BOB))));
  ...
  private static List<AccountSettings> accountsOfAlice(final Graph graph) {
    ...
    final AccountSettings accountSettings = accountSettings(BOB, USD, IlpRelationship.CHILD, pluginSettings);
  ...
  private static List<AccountSettings> accountsOfBob(final Graph graph) {
    ...
    final AccountSettings aliceAccountSettings = accountSettings(ALICE, USD, IlpRelationship.PARENT, pluginSettings);
  ...
  private static AccountSettings accountSettings(
    ...
    final IlpRelationship ilpRelationship, final PluginSettings pluginSettings
  ) {
  ...
  private static ConnectorNode toConnectorNode(final Graph graph, final InterledgerAddress nodeName) {
