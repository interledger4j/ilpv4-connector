...
/**
 * An implementation of {@link IlpClient} that simulates a relationship with a parent node where this connector is the
 * child.
 */
public class SimulatedClient extends AbstractIlpClient<IlpClientSettings> implements IlpClient<IlpClientSettings> {
   ...
   */
  public SimulatedClient(final IlpClientSettings ilpClientSettings) {
