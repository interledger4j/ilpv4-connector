package org.interledger.connector.opay.service.ilp;
...
public class OpaStreamConnectionGenerator implements StreamConnectionGenerator {
   ...
   * Open Payments addresses should have the encoded {@link org.interledger.connector.opay.InvoiceId} as part of
