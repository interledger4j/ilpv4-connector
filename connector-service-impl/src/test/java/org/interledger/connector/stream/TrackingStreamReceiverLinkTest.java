...
/**
 * Unit tests for {@link TrackingStreamReceiverLink}.
 */
public class TrackingStreamReceiverLinkTest {
  ...
  private TrackingStreamReceiverLink link;

  @Before
  public void setUp() {
    MockitoAnnotations.initMocks(this);

    this.link = new TrackingStreamReceiverLink(
        () -> OPERATOR_ADDRESS,
  ...
  public void registerLinkHandler() {
    try {
      ...
      assertThat(e.getMessage())
          .isEqualTo("TrackingStreamReceiver links never emit data, and thus should not have a registered DataHandler.");
      throw e;
    }
  }
