...
public class SettlementEngineClientConfig {
  ...
  protected ConnectionPool seConnectionPool(
    @Value("${interledger.connector.settlementEngines.connectionDefaults.maxIdleConnections:5}")
    final int defaultMaxIdleConnections,
    @Value("${interledger.connector.settlementEngines.connectionDefaults.keepAliveMinutes:5}")
  ...
  protected OkHttpClient okHttpClient(
    ...
    @Value("${interledger.connector.settlementEngines.connectionDefaults.connectTimeoutMillis:10000}")
    final long defaultConnectTimeoutMillis,
    @Value("${interledger.connector.settlementEngines.connectionDefaults.readTimeoutMillis:30000}")
    final long defaultReadTimeoutMillis,
    @Value("${interledger.connector.settlementEngines.connectionDefaults.writeTimeoutMillis:30000}")
