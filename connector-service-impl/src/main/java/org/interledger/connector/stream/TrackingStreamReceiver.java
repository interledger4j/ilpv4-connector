...
public class TrackingStreamReceiver implements StreamReceiver {
  ...
  public TrackingStreamReceiver(
    ...
    this.fulfillmentGeneratedEventAggregator =
      Objects.requireNonNull(fulfillmentGeneratedEventAggregator, "fulfillmentGeneratedEventAggregator must not be null");
  }
  ...
  public InterledgerResponsePacket receiveMoney(
    ...
    if (isFulfillable && is(preparePacket.getAmount()).greaterThanEqualTo(streamPacket.prepareAmount())) {
      ...
      try {
        ...
        InterledgerFulfillPacket fulfillPacket = InterledgerFulfillPacket.builder()
