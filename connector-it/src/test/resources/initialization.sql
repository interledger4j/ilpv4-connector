...
-- Changeset db/changelogs/base/changelog.xml::static_routes::isimpson
CREATE TABLE public.static_routes (
    ...
    CONSTRAINT STATIC_ROUTES_PKEY PRIMARY KEY (ID),
    UNIQUE (NATURAL_ID)
);

CREATE UNIQUE INDEX STATIC_ROUTES_PREFIX_IDX ON public.STATIC_ROUTES(NATURAL_ID);
