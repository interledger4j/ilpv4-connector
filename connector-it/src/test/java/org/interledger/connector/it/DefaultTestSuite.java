...
import org.interledger.connector.it.coordination.TwoConnectorAccountCoordinationIT;
...
@Categories.IncludeCategory({Performance.class, IlpOverHttp.class, Coordination.class})
// Note that Categories is a kind of Suite
@Suite.SuiteClasses({TwoConnectorIlpOverHttpPingTestIT.class, TwoConnectorIldcpTestIT.class,
    TwoConnectorMixedAssetCodeTestIT.class, TwoConnectorAccountCoordinationIT.class})
