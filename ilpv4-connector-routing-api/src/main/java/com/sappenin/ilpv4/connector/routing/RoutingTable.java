...
public interface RoutingTable<R extends BaseRoute> {
   ...
   */
  Route addRoute(InterledgerAddressPrefix routePrefix, R route);

  /**
   * Remove a particular getRoute from the routing table, based upon its target prefix.
   *
   * @param routePrefix The address prefix that uniquely identifies the getRoute to removeEntry from this routing table.
   */
