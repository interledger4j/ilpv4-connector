...
/**
 * <p>Represents a prefix for an {@link InterledgerAddress}, allowing any valid Interledger address as well as
 * allocation schemes.</p>
 *
 * @deprecated Will move to Quilt if used.
 */
@Deprecated
public interface InterledgerAddressPrefix {
  ...
  /**
   * Compute the root-prefix of the supplied {@code address}. If this prefix is already a root-prefix (i.e., an
   * AllocationScheme) then this prefix is returned.
   *
   * @return An {@link InterledgerAddressPrefix} representing the root prefix for the supplied Interledger address.
   */
