...
import static com.sappenin.ilpv4.InterledgerAddressPrefix.AbstractInterledgerAddressPrefix.Error.*;
...
public class InterledgerAddressPrefixTest {
  ...
  public void testConstruction_DeliverableAddress() {
    final InterledgerAddressPrefix address = InterledgerAddressPrefix.builder().value(TEST1_US_USD_BOB).build();
    assertThat(address.getValue(), is(TEST1_US_USD_BOB));
  }

  @Test
  public void testConstruction_LedgerPrefix() {
    final InterledgerAddressPrefix address = InterledgerAddressPrefix.builder().value(TEST1_US_USD).build();
  ...
  public void test_blank_address() {
    try {
      ...
      assertThat(
        e.getMessage(),
        is(String.format(
          InterledgerAddressPrefix.AbstractInterledgerAddressPrefix.Error.INVALID_SCHEME_PREFIX.getMessageFormat(),
          "  "))
      );
      throw e;
    }
  ...
  public void test_address_just_right_length() {
    ...
    final InterledgerAddressPrefix address = InterledgerAddressPrefix.builder().value(JUST_RIGHT).build();
  ...
  public void test_address_all_valid_characters() {
    ...
    final InterledgerAddressPrefix address = InterledgerAddressPrefix.builder().value(allValues).build();
  ...
  public void testAddressWithNull() {
    final InterledgerAddressPrefix addressPrefix = InterledgerAddressPrefix.of("g.foo");
    try {
  ...
  public void testGetPrefixFromLongPrefix() {
    final InterledgerAddressPrefix address = InterledgerAddressPrefix.of("g.alpha.beta.charlie.delta.echo");
  ...
  public void testToString() {
    ...
    assertThat(InterledgerAddressPrefix.of("g.foo").toString(),
  ...
  public void testValidateWithInvalidSchemePrefix_02() {
    assertValidationErrorThenThrow(".self",
      InterledgerAddressPrefix.AbstractInterledgerAddressPrefix.Error.INVALID_SCHEME_PREFIX);
  }
  ...
  public void testValidateWithInvalidSchemePrefix_05() {
    assertValidationErrorThenThrow("gg",
      InterledgerAddressPrefix.AbstractInterledgerAddressPrefix.Error.INVALID_SCHEME_PREFIX, "gg");
  }

  @Test(expected = IllegalArgumentException.class)
  public void testValidateWithInvalidSchemePrefix_06() {
    assertValidationErrorThenThrow(" g",
      InterledgerAddressPrefix.AbstractInterledgerAddressPrefix.Error.INVALID_SCHEME_PREFIX, " g");
  }
  ...
  private void assertValidationErrorThenThrow(final String actualAddressString,
                                              final InterledgerAddressPrefix.AbstractInterledgerAddressPrefix.Error expectedError, final Object... errorParams) {
    try {
  ...
  public void getRootPrefix() {
    ...
    assertThat(InterledgerAddressPrefix.of("g.baz.bool.foo.bar.boo").getRootPrefix().getValue(), is("g"));
