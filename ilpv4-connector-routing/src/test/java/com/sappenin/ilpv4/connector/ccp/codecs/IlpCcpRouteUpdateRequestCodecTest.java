...
public class IlpCcpRouteUpdateRequestCodecTest extends AbstractAsnCodecTest<InterledgerPreparePacket> {

  private static final String EXECUTION_CONDITION_HEX =
    "66687AADF862BD776C8FC18B8E9F8E20089714856EE233B3902A591D0D5F2925";

  private static final InterledgerAddress PEER_ROUTE_UPDATE_DESTINATION = InterledgerAddress.of("peer.route.update");
   ...
   */
  public IlpCcpRouteUpdateRequestCodecTest(
                ...
                codecContext.write(
                  ImmutableCcpRouteUpdateRequest.builder()
                    ...
                    .newRoutes(Lists.newArrayList(
                      ImmutableCcpRoute.builder()
                        .prefix(InterledgerAddress.of("example.prefix1"))
                        .path(
                          Lists.newArrayList(
                        ...
                        .build(),
                      ImmutableCcpRoute.builder()
                        .prefix(InterledgerAddress.of("example.prefix2"))
                        .path(
                          Lists.newArrayList(
                            ImmutableCcpRoutePathPart.builder()
                    ...
                    .withdrawnRoutePrefixes(
                      Lists.newArrayList(
                        ImmutableCcpWithdrawnRoute.builder().prefix(InterledgerAddress.of("example.prefix3")).build(),
                        ImmutableCcpWithdrawnRoute.builder().prefix(InterledgerAddress.of("example.prefix4")).build()
                      )
                    )
                    .build()
                  , baos);
