...
/**
 * A simple implementation of {@link PaymentRouter} that chooses the first available route in the routing table for any
 * given final-destination address.
 *
 * @deprecated TODO: DELETE THIS CLASS IF IT'S UNUSED! This functionality is now found in RoutingService.
 */
@Deprecated
