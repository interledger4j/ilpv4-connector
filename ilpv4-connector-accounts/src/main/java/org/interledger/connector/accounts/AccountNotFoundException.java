...
public class AccountNotFoundException extends AccountException {
   ...
   */
  public AccountNotFoundException(AccountId pluginAccount) {
    super(pluginAccount);
  }
   ...
   *                method.
   */
  public AccountNotFoundException(String message, AccountId pluginAccount) {
   ...
   * @since 1.4
   */
  public AccountNotFoundException(Throwable cause, AccountId pluginAccount) {
  ...
  public AccountNotFoundException(String message, Throwable cause, boolean enableSuppression,
                                  boolean writableStackTrace, AccountId pluginAccount) {
