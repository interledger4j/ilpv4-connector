...
public class PaymentEntity extends AbstractEntity {
  ...
  public PaymentEntity(final Payment payment) {
    ...
    this.invoiceId = payment.invoiceId()
      .orElseThrow(() -> new IllegalArgumentException("Payment must have invoiceId before before being stored."))
      .value();
  ...
  public void setInvoiceId(String invoiceUrl) {
    this.invoiceId = invoiceUrl;
  }
